/**
 * @file Implements DAO managing data storage of bookmarks. Uses mongoose UserModel
...
export default class BookmarkDao implements BookmarkDaoI {
    ...
    /**
     * Uses BookmarkModel to retrieve bookmark documents from the bookmarks collection
